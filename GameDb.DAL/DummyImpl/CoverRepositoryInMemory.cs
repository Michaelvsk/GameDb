...
public class CoverRepositoryInMemory : ICoverRepository
{
    readonly List<Cover> _covers = new()
    {
        ...
        new Cover(
            ...
            Resources.Covers._11111111_1111_1111_1111_111111111112
...
//                , "11111111-1111-1111-1111-111111111112.png"))
        ...
        ,
        new Cover(
            new Guid("21111111-1111-1111-1111-111111111112"),
            Resources.Covers._21111111_1111_1111_1111_111111111112
//            File.ReadAllBytes(Path.Combine(
//#pragma warning disable CS8604 // Possible null reference argument.
//                Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location)
//#pragma warning restore CS8604 // Possible null reference argument.
